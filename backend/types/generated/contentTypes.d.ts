...
export interface ApiBlogArticleBlogArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    date: Schema.Attribute.DateTime &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'2024-11-15T11:15:00.000Z'>;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    endingDate: Schema.Attribute.Date & Schema.Attribute.Required;
...
export interface ApiInfoblocksBlogInfoblocksBlog
  extends Struct.SingleTypeSchema {
  collectionName: 'infoblocks_blogs';
  info: {
    displayName: 'infoblocks Blog';
    pluralName: 'infoblocks-blogs';
    singularName: 'infoblocks-blog';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::infoblocks-blog.infoblocks-blog'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::infoblocks-blog.infoblocks-blog': ApiInfoblocksBlogInfoblocksBlog;
